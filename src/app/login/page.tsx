...
export default function LoginPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#EDEDED] dark:bg-[#111a36]">
  ...
  return (
    ...
    >
      ...
      <button
        onClick={toggleTheme}
        className="absolute top-5 right-5 z-20 p-2.5 rounded-full bg-white/80 dark:bg-[#1e2e5a]/80 hover:bg-white dark:hover:bg-[#1e2e5a] border border-theme shadow-md transition-all cursor-pointer"
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="bg-white/95 dark:bg-[#1e2e5a]/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-theme dark:border-[#2e3f6d]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-theme rounded-lg bg-white dark:bg-[#0c328f]/40 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1067f2] focus:border-transparent transition-all"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-2.5 px-4 bg-[#1067f2] hover:bg-[#0c328f] active:bg-[#1e2e5a] text-white font-title font-bold rounded-lg transition-all shadow-md shadow-blue-500/20 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
            >
              {submitting ? (
                <>
